---
title: "<br><span style='color:#FDB913'>Data Visualization and Shiny</span>"
...
<img src="images/dataviz/ggplot2.svg" width="100" height="100" style="opacity: 0.5;" align="right"/>
...
<img src="images/dataviz/ggplot2ex.png" width="1205" height="589"/>
...
<img src="images/shiny/shiny.png" width="100" height="100" style="opacity: 0.5;" align="right"/>

Shiny is a package that allows R programmers to develop interactive web applications with little friction.

-   In particular, no HTML, CSS or JavaScript knowledge is required.
-   Shiny was built with R in mind! If your R code is at all modular, it is easy to plug into a Shiny app.

Most commonly, Shiny is used to create interactive data dashboards, though more technical apps are also possible.  

-   Some examples are available on the [Shiny gallery](https://shiny.posit.co/r/gallery/).
