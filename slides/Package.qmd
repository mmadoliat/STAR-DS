...
-   o save yourself time with conventions and structure
:::
...
-   DDocumentation — using **roxygen2** comments above each function
:::
...
-   Step 3: Write Your Functions (R code in `R/`)

-   Step 4: Add Compiled Code (Optional `src/` for Rcpp/C++) 

-   Step 5: Document Your Functions

-   Step 6: Load and Check the Package
